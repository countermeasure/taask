    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ends', models.DateTimeField(null=True, verbose_name=b'Recurs until', blank=True)),
                ('frequency', models.CharField(max_length=100, blank=True)),
                ('notes', models.TextField(blank=True)),
                ('scheduled', models.DateTimeField(null=True, verbose_name=b'Postpone until', blank=True)),
                ('starts', models.DateTimeField(null=True, verbose_name=b'First occurance', blank=True)),
                ('status', models.CharField(default=b'active', max_length=20, choices=[(b'active', b'active'), (b'completed', b'completed')])),
